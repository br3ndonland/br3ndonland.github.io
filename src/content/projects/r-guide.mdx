...
<LightboxImage
  src={punchedCard}
  alt="IBM 360 PL/1 punched card program, circa 1969"
  description={`From <a href="https://commons.wikimedia.org/wiki/File:Punched_card_program_deck.agr.jpg" rel="external" target="_blank">Wikimedia Commons by user ArnoldReinhold</a>, licensed under <a href="https://creativecommons.org/licenses/by-sa/3.0/" rel="external" target="_blank">CC BY-SA 3.0</a>.`}
  imageClass="img-thumbnail"
  gallery="r-guide"
  decoding="async"
  loading="lazy"
/>
<Icon icon="arrow-bend-left-up" size="1.2em" verticalAlign="top" />_IBM 360 PL/1 punched card program._
...
<figure className="image-grid image-grid-pair">
  ...
  <figcaption>
    ...
    <em>
      {
        "Comparison of Markdown and HTML code for the R example on this page. Which would you rather write?"
      }
    </em>
  </figcaption>
</figure>
