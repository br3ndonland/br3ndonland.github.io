...
I've been an early adopter of OpenTofu and have been very happy with it. At Formation Bio, I led the transition from Terraform to OpenTofu, making the key code changes and providing support to other users in the organization. It was a smooth and productive transition, and I think the future is bright for OpenTofu.
...
One such TACO is <a href="https://spacelift.io/" rel="external" target="_blank">Spacelift</a>. A cloud consultancy called <a href="https://masterpoint.io/" rel="external" target="_blank">Masterpoint</a> helped with some of the initial setup of Spacelift, then I took on primary responsibility for Spacelift administration after Masterpoint was done. Spacelift was a valuable tool for Formation Bio, and after seeing how beneficial it was, Spacelift published our <a href="https://spacelift.io/customers/formation-bio" rel="external" target="_blank">customer success story</a> and <a href="https://www.linkedin.com/posts/heard-from-spacelift-customers-brendon-smith-ugcPost-7497746422147080193-LCOD/" rel="external" target="_blank">interviewed me about it</a>.

I would also highlight the following key features I used as a Spacelift administrator:
...
- <a href="https://docs.spacelift.io/vendors/terraform/workflow-tool" rel="external" target="_blank">Custom workflow tool</a> - we adapted this to support Terraspace, an IaC orchestration tool
- OpenTofu support - Spacelift helped us make a smooth transition from HashiCorp Terraform to OpenTofu

## Snowflake

Developing drugs with AI is a data-intensive process, not only because of data Formation Bio themselves generate, but also datasets they acquire and use. For this reason, Formation Bio has a Data Platform team that helps to wrangle all the data. The Data Platform team had selected a "data warehouse" product called <a href="https://www.snowflake.com/en/" rel="external" target="_blank">Snowflake</a> to help store the data. I was "embedded" within the Data Platform team and helped to administrate Snowflake, including using the <a href="https://search.opentofu.org/provider/snowflakedb/snowflake/latest" rel="external" target="_blank">Snowflake OpenTofu provider</a> to configure networking between Snowflake and other cloud platforms and networks.
...
Formation Bio was unusually diligent about their cloud infrastructure, but nonetheless saw a need to re-architect their AWS network, particularly the public networking aspects. I took a lead role in defining the network architecture and developing expertise in the many resources involved, including VPCs (Virtual Private Clouds), VPC security groups, VPC subnets, route tables, internet gateways (IGWs), NAT gateways, load balancers (ALB/NLB), and more.
